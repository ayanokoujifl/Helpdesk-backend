...
import com.ayanokoujifl.helpdesk.services.TecnicoService;
...
public class TecnicoController {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<TecnicoDTO> update(@Valid @RequestBody TecnicoDTO objDto, @PathVariable Integer id) {
